package com.servicing.micronaut.httpclient;
...
public class GithubLowLevelClient {
   ...
   public  Publisher<List<GithubRelease>> fetchReleases() {
    ...
    @SingleResult
	public Publisher<String> refreshCodeTables() {
    	HttpRequest<?> req = HttpRequest.GET(GithubConfiguration.GITHUB_API_URL); // <4>
        return httpClient.retrieve(req,String.class); // <7>
	}
}
